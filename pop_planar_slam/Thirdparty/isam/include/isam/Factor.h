...
protected:
  ...
  T _measure; // by me, not const, update the measurement
...
public:
  ...
  const Noise& noise() const {return _noise;}  // add by me 
  
  void set_measurement(const T& new_measure) {_measure=new_measure;} // add by me
