...
// template <class T>  // add by me
// class FactorT; // add by me
...
//   std::list<FactorT<T>*> _factorTs; // list of adjacent factors  add by me
public:
...
//   const std::list<FactorT<T>*>& factorTs() {return _factorTs;}  // add by me
